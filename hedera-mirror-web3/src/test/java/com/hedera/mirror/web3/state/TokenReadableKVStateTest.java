...
class TokenReadableKVStateTest {
    ...
    void getTokenMappedValues() {
        ...
        assertThat(tokenReadableKVState.readFromDataSource(TOKEN_ID)).satisfies(token -> assertThat(token)
                ...
                .returns(
                        ...
                        Token::supplyType)
                .returns(databaseToken.getTotalSupply(), Token::totalSupply)
    ...
    void getCustomFees() {
        ...
        assertThat(tokenReadableKVState.readFromDataSource(TOKEN_ID))
                .satisfies(token -> assertThat(token.customFees()).isEqualTo(Collections.emptyList()));
    ...
    void getPartialTreasuryAccount() {
        ...
        assertThat(tokenReadableKVState.readFromDataSource(TOKEN_ID))
                .satisfies(token -> assertThat(token.treasuryAccountId()).isEqualTo(expectedTreasuryAccountId));
    ...
    void getPartialTreasuryAccountHistorical() {
        ...
        Entity treasuryEntity = mock(Entity.class);
        when(commonEntityAccessor.get(TOKEN_ID, timestamp)).thenReturn(Optional.ofNullable(entity));
        when(treasuryEntity.getShard()).thenReturn(0L);
        when(treasuryEntity.getRealm()).thenReturn(0L);
        when(treasuryEntity.getNum()).thenReturn(10L);
    ...
    void getAutoRenewAccount() {
        ...
        when(commonEntityAccessor.get(TOKEN_ID, Optional.empty())).thenReturn(Optional.ofNullable(entity));
        when(autorenewEntity.getShard()).thenReturn(0L);
        when(autorenewEntity.getRealm()).thenReturn(0L);
        when(autorenewEntity.getNum()).thenReturn(10L);
        ...
        assertThat(tokenReadableKVState.readFromDataSource(TOKEN_ID))
                .satisfies(token -> assertThat(token.autoRenewAccountId()).isEqualTo(autoRenewAccountId));
    ...
    void getTotalSupplyHistoricalFungible() {
        ...
        assertThat(tokenReadableKVState.readFromDataSource(TOKEN_ID))
                .satisfies(token -> assertThat(token.totalSupply()).isEqualTo(historicalSupply));
    ...
    void getTokenKeysValues() {
        ...
        assertThat(tokenReadableKVState.readFromDataSource(TOKEN_ID)).satisfies(token -> assertThat(token)
                .returns(Utils.parseKey(entity.getKey(), entity.getId()), Token::adminKey)
                .returns(Utils.parseKey(databaseToken.getKycKey(), entity.getId()), Token::kycKey)
                .returns(Utils.parseKey(databaseToken.getPauseKey(), entity.getId()), Token::pauseKey)
                .returns(Utils.parseKey(databaseToken.getFreezeKey(), entity.getId()), Token::freezeKey)
                .returns(Utils.parseKey(databaseToken.getWipeKey(), entity.getId()), Token::wipeKey)
                .returns(Utils.parseKey(databaseToken.getSupplyKey(), entity.getId()), Token::supplyKey)
                .returns(Utils.parseKey(databaseToken.getFeeScheduleKey(), entity.getId()), Token::feeScheduleKey));
    }
    ...
    void getTokenKeysValuesHistorical() {
        ...
        assertThat(tokenReadableKVState.readFromDataSource(TOKEN_ID)).satisfies(token -> assertThat(token)
                .returns(
                        Utils.parseKey(entity.getKey(), entity.getId()),
                        com.hedera.hapi.node.state.token.Token::adminKey)
                .returns(Utils.parseKey(databaseToken.getKycKey(), entity.getId()), Token::kycKey)
                .returns(Utils.parseKey(databaseToken.getPauseKey(), entity.getId()), Token::pauseKey)
                .returns(Utils.parseKey(databaseToken.getFreezeKey(), entity.getId()), Token::freezeKey)
                .returns(Utils.parseKey(databaseToken.getWipeKey(), entity.getId()), Token::wipeKey)
