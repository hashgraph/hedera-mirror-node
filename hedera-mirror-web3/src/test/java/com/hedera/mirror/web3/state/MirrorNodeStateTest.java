...
class MirrorNodeStateTest {
    ...
    //        final var newState =
    //                mirrorNodeState.addService("NEW", new HashMap<>(Map.of("FILES", Map.of("FILES",
    // fileReadableKVState))));
    ...
    //                        Map.of("FILES", new MapReadableKVState<>("FILES", Map.of("FILES",
    // fileReadableKVState))))));
    //    }
    //
    //    @Test
    ...
    //                        "PENDING_AIRDROPS",
    //                        new MapReadableKVState("PENDING_AIRDROPS", Map.of("PENDING_AIRDROPS",
    ...
    //                        "TOKEN_RELS",
    //                        new MapReadableKVState("TOKEN_RELS", Map.of("TOKEN_RELS",
    ...
    //                        Map.of("FILES", new MapWritableKVState<>("FILES", Map.of("FILES",
    // fileReadableKVState)))));
    //    }
    //
    //    @Test
    ...
    //        final Map<String, Object> fileStateData = new HashMap<>(Map.of("FILES", Map.of("FILES",
    // fileReadableKVState)));
