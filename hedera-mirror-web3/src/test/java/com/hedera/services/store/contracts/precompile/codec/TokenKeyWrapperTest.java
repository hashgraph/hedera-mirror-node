...
class TokenKeyWrapperTest {
    ...
    void createsExpectedTokenKeyWrapper() {
        ...
        tokenKeyWrapper = new TokenKeyWrapper(
                4, new KeyValueWrapper(false, null, new byte[ED25519_BYTE_LENGTH], new byte[] {}, null));
        assertTrue(tokenKeyWrapper.isUsedForFreezeKey());

        tokenKeyWrapper = new TokenKeyWrapper(
                8, new KeyValueWrapper(false, null, new byte[ED25519_BYTE_LENGTH], new byte[] {}, null));
        assertTrue(tokenKeyWrapper.isUsedForWipeKey());

        tokenKeyWrapper = new TokenKeyWrapper(
                16, new KeyValueWrapper(false, null, new byte[ED25519_BYTE_LENGTH], new byte[] {}, null));
