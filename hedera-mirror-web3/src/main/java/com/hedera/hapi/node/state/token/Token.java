 ...
 * @param totalSupply <b>(5)</b> The total supply of this token.
 * @param totalSupplySupplier <b>(6)</b> The total supply of this token wrapped in a Supplier.
 * @param treasuryAccountId <b>(7)</b> The treasury account id of this token. This account receives the initial supply of
 ...
 * @param treasuryAccountIdSupplier <b>(8)</b> The treasury account id of this token wrapped in a Supplier.
 * @param adminKey <b>(9)</b> (Optional) The admin key of this token. If this key is set, the token is mutable.
 *                 A mutable token can be modified.
 *                 If this key is not set on token creation, it cannot be modified.
 * @param kycKey <b>(10)</b> (Optional) The kyc key of this token.
 *               If this key is not set on token creation, it can only be set if the token has admin key set.
 * @param freezeKey <b>(11)</b> (Optional) The freeze key of this token. This key is needed for freezing the token.
 *                  If this key is not set on token creation, it can only be set if the token has admin key set.
 * @param wipeKey <b>(12)</b> (Optional) The wipe key of this token. This key is needed for wiping the token.
 *                If this key is not set on token creation, it can only be set if the token has admin key set.
 * @param supplyKey <b>(13)</b> (Optional) The supply key of this token. This key is needed for minting or burning token.
 *                  If this key is not set on token creation, it can only be set if the token has admin key set.
 * @param feeScheduleKey <b>(14)</b> (Optional) The fee schedule key of this token. This key should be set, in order to make any
 *                       changes to the custom fee schedule.
 *                       If this key is not set on token creation, it can only be set if the token has admin key set.
 * @param pauseKey <b>(15)</b> (Optional) The pause key of this token. This key is needed for pausing the token.
 *                 If this key is not set on token creation, it can only be set if the token has admin key set.
 * @param lastUsedSerialNumber <b>(16)</b> The last used serial number of this token.
 * @param deleted <b>(17)</b> The flag indicating if this token is deleted.
 * @param tokenType <b>(18)</b> The type of this token. A token can be either FUNGIBLE_COMMON or NON_FUNGIBLE_UNIQUE.
 *                  If it has been omitted during token creation, FUNGIBLE_COMMON type is used.
 * @param supplyType <b>(19)</b> The supply type of this token.A token can have either INFINITE or FINITE supply type.
 *                   If it has been omitted during token creation, INFINITE type is used.
 * @param autoRenewAccountId <b>(20)</b> The id of the account (if any) that the network will attempt to charge for the
 *                           token's auto-renewal upon expiration.
 * @param autoRenewAccountIdSupplier <b>(21)</b> The id of the account (if any) that the network will attempt to charge for the
 *  *                           token's auto-renewal upon expiration wrapped in a Supplier.
 * @param autoRenewSeconds <b>(22)</b> The number of seconds the network should automatically extend the token's expiration by, if the
 ...
 * @param expirationSecond <b>(23)</b> The expiration time of the token, in seconds since the epoch.
 * @param memo <b>(24)</b> An optional description of the token with UTF-8 encoding up to 100 bytes.
 * @param maxSupply <b>(25)</b> The maximum supply of this token.
 * @param paused <b>(26)</b> The flag indicating if this token is paused.
 * @param accountsFrozenByDefault <b>(27)</b> The flag indicating if this token has accounts associated to it that are frozen by default.
 * @param accountsKycGrantedByDefault <b>(28)</b> The flag indicating if this token has accounts associated with it that are KYC granted by default.
 * @param customFees <b>(29)</b> (Optional) The custom fees of this token.
 * @param customFeesSupplier <b>(30)</b> (Optional) The custom fees of this token wrapped in a Supplier.
 * @param metadata <b>(31)</b> Metadata of the created token definition
 * @param metadataKey <b>(32)</b> The key which can change the metadata of a token
...
public record Token(
    ...
    public int hashCode() {
        ...
        if (totalSupply != DEFAULT.totalSupply) {
            result = 31 * result + Long.hashCode(totalSupply);
        }
    ...
    public boolean equals(Object that) {
        ...
        if (totalSupply != thatObj.totalSupply) {
            return false;
        }
        ...
        if (!customFees.equals(thatObj.customFees)) {
            return false;
        }
    ...
    public static final class Builder {
        ...
        /**
         * <b>(6)</b> The total supply of this token.
         *
        ...
        /**
         * <b>(7)</b> The treasury account id of this token. This account receives the initial supply of
         * tokens as well as the tokens from the Token Mint operation once executed. The balance
         * of the treasury account is decreased when the Token Burn operation is executed.
         *
        ...
        /**
         * <b>(8)</b> The treasury account id of this token. This account receives the initial supply of
         * tokens as well as the tokens from the Token Mint operation once executed. The balance
         * of the treasury account is decreased when the Token Burn operation is executed.
         *
        ...
        /**
         * <b>(9)</b> (Optional) The admin key of this token. If this key is set, the token is mutable.
         * A mutable token can be modified.
         * If this key is not set on token creation, it cannot be modified.
         *
        ...
        /**
         * <b>(10)</b> (Optional) The kyc key of this token.
         * If this key is not set on token creation, it can only be set if the token has admin key set.
         *
        ...
        /**
         * <b>(11)</b> (Optional) The freeze key of this token. This key is needed for freezing the token.
         * If this key is not set on token creation, it can only be set if the token has admin key set.
         *
        ...
        /**
         * <b>(12)</b> (Optional) The wipe key of this token. This key is needed for wiping the token.
         * If this key is not set on token creation, it can only be set if the token has admin key set.
         *
        ...
        /**
         * <b>(13)</b> (Optional) The supply key of this token. This key is needed for minting or burning token.
         * If this key is not set on token creation, it can only be set if the token has admin key set.
         *
        ...
        /**
         * <b>(14)</b> (Optional) The fee schedule key of this token. This key should be set, in order to make any
         * changes to the custom fee schedule.
         * If this key is not set on token creation, it can only be set if the token has admin key set.
         *
        ...
        /**
         * <b>(15)</b> (Optional) The pause key of this token. This key is needed for pausing the token.
         * If this key is not set on token creation, it can only be set if the token has admin key set.
         *
        ...
        /**
         * <b>(16)</b> The last used serial number of this token.
         *
        ...
        /**
         * <b>(17)</b> The flag indicating if this token is deleted.
         *
        ...
        /**
         * <b>(18)</b> The type of this token. A token can be either FUNGIBLE_COMMON or NON_FUNGIBLE_UNIQUE.
         * If it has been omitted during token creation, FUNGIBLE_COMMON type is used.
         *
        ...
        /**
         * <b>(19)</b> The supply type of this token.A token can have either INFINITE or FINITE supply type.
         * If it has been omitted during token creation, INFINITE type is used.
         *
        ...
        /**
         * <b>(20)</b> The id of the account (if any) that the network will attempt to charge for the
         * token's auto-renewal upon expiration.
         *
        ...
        /**
         * <b>(21)</b> The id of the account (if any) that the network will attempt to charge for the
         * token's auto-renewal upon expiration.
         *
        ...
        /**
         * <b>(22)</b> The number of seconds the network should automatically extend the token's expiration by, if the
         * token has a valid auto-renew account, and is not deleted upon expiration.
         * If this is not provided in a allowed range on token creation, the transaction will fail with INVALID_AUTO_RENEWAL_PERIOD.
         * The default values for the minimum period and maximum period are 30 days and 90 days, respectively.
         *
        ...
        /**
         * <b>(23)</b> The expiration time of the token, in seconds since the epoch.
         *
        ...
        /**
         * <b>(24)</b> An optional description of the token with UTF-8 encoding up to 100 bytes.
         *
        ...
        /**
         * <b>(25)</b> The maximum supply of this token.
         *
        ...
        /**
         * <b>(26)</b> The flag indicating if this token is paused.
         *
        ...
        /**
         * <b>(27)</b> The flag indicating if this token has accounts associated to it that are frozen by default.
         *
        ...
        /**
         * <b>(28)</b> The flag indicating if this token has accounts associated with it that are KYC granted by default.
         *
        ...
        /**
         * <b>(29)</b> (Optional) The custom fees of this token.
         *
        ...
        /**
         * <b>(30)</b> (Optional) The custom fees of this token.
         *
        ...
        /**
         * <b>(31)</b> Metadata of the created token definition
         *
        ...
        /**
         * <b>(32)</b> The key which can change the metadata of a token
         * (token definition and individual NFTs).
         *
