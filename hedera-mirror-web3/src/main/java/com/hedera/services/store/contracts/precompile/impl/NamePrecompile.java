...
/**
 * This class is a modified copy of NamePrecompile from hedera-services repo.
 * <p>
...
public class NamePrecompile extends AbstractReadOnlyPrecompile {
    ...
    public Set<Integer> getFunctionSelectors() {
        return Set.of(AbiConstants.ABI_ID_ERC_NAME);
    }

    @Override
    public Bytes getSuccessResultFor(final RunResult runResult) {
        final var nameResult = (TokenNameResult) runResult;
        return encoder.encodeName(nameResult.name());
    }
