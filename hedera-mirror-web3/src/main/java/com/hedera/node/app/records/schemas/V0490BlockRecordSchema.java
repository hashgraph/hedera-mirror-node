...
public class V0490BlockRecordSchema extends Schema {
    ...
    public @NonNull Set<StateDefinition> statesToCreate() {
        return Set.of(
                ...
                StateDefinition.onDisk(BLOCK_INFO_STATE_KEY, BlockInfo.PROTOBUF, BlockInfo.PROTOBUF, 1000L));
    }
    ...
    public void migrate(@NonNull final MigrationContext ctx) {
        ...
        if (isGenesis) {
            final var blocksState = ctx.newStates().get(BLOCK_INFO_STATE_KEY);
