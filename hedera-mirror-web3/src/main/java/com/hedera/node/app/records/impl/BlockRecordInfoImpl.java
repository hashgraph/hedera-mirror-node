...
import com.hedera.mirror.web3.state.BlockInfoReadableKVState;
...
public final class BlockRecordInfoImpl implements BlockRecordInfo {
    ...
    public static BlockRecordInfoImpl from(@NonNull final State state) {
        ...
        final var blockIndex = recordFile != null ? recordFile.getIndex() : BlockInfoReadableKVState.LATEST_BLOCK_KEY;
        final var blockInfoState = (BlockInfo)
                states.get(V0490BlockRecordSchema.BLOCK_INFO_STATE_KEY).get(blockIndex);
