...
public class HederaEvmTransactionProcessingResult {
    ...
    private final Optional<ResponseCodeEnum> decodedRevertReason;
    ...
    public static HederaEvmTransactionProcessingResult failed(
            ...
            final long gasPrice,
            final Optional<Bytes> revertReason,
            final Optional<ResponseCodeEnum> decodedRevertReason,
            final Optional<ExceptionalHaltReason> haltReason) {
        return new HederaEvmTransactionProcessingResult(
                Status.FAILED,
                Collections.emptyList(),
    ...
    protected HederaEvmTransactionProcessingResult(
        ...
        this.decodedRevertReason = decodedRevertReason;
    }
    ...
    public Optional<ResponseCodeEnum> getDecodedRevertReason() {
        return decodedRevertReason;
    }
}
