...
public class TokenReadableKVState extends ReadableKVStateBase<TokenID, Token> {
    ...
    private Token tokenFromEntities(
        ...
        return Token.newBuilder()
                ...
                .adminKey(Utils.parseKey(entity.getKey(), entity.getId()))
                .kycKey(Utils.parseKey(token.getKycKey(), entity.getId()))
                .freezeKey(Utils.parseKey(token.getFreezeKey(), entity.getId()))
                .wipeKey(Utils.parseKey(token.getWipeKey(), entity.getId()))
                .supplyKey(Utils.parseKey(token.getSupplyKey(), entity.getId()))
                .feeScheduleKey(Utils.parseKey(token.getFeeScheduleKey(), entity.getId()))
                .pauseKey(Utils.parseKey(token.getPauseKey(), entity.getId()))
                .deleted(false)
                ...
                .metadataKey(Utils.parseKey(token.getMetadataKey(), entity.getId()))
