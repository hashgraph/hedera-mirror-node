...
import static com.hedera.mirror.web3.convert.BytesDecoder.maybeDecodeSolidityErrorToReadableMessage;
    ...
    private HederaEvmTransactionProcessingResult doProcessCall(final CallServiceParameters body) {
        ...
        try {
            ...
            if(!txnResult.isSuccessful()) {
                ...
                throw new InvalidTransactionException(getStatusOrDefault(txnResult), maybeDecodeSolidityErrorToReadableMessage(revertReason), revertReason.toHexString());
            } else {
