...
| `hedera.mirror.parser.record.persistNonFeeTransfersAlways` | false                   | Persist non-fee transfers for transactions always vs only when record's transferlist is not itemized |
