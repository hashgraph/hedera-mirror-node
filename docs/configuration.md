...
| `hedera.mirror.importer.parser.event.queueCapacity`                              | 1                                                | How many event files to queue in memory while waiting to be persisted by the parser                                                                                                                                                                                |
...
| `hedera.mirror.importer.parser.record.historicalBalance.minFrequency`            | 15m                                              | How often at least to generate balances information. Can accept duration units like `10s`, `2m` etc.                                                                                                                                                               |
...
| `hedera.mirror.importer.parser.record.queueCapacity`                             | 1                                                | How many record files to queue in memory while waiting to be persisted by the parser                                                                                                                                                                               |
...
--------------------------------------------------------|----------------------------------------------------|-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
 ...
 `hedera.mirror.web3.evm.estimateGasIterationThreshold` | 7300                                               | The gas value difference between consecutive iterations in the binary search performed during gas estimation                                                                                  
 ...
 `hedera.mirror.web3.evm.maxAutoRenewDuration`          | 10000                                              | Maximum duration for auto-renew account                                                                                                                                                       
