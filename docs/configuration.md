...
| `hedera.mirror.importer.parser.record.retry.multiplier`                     | 2                              | Used to generate the next delay for backoff                                                                                                                                                                                                                        |
| `hedera.mirror.importer.parser.record.sidecar.enabled`                      | true                           | Whether to download and read sidecar record files                                                                                                                                                                                                                  |
| `hedera.mirror.importer.parser.record.sidecar.types`                        | CONTRACT_STATE_CHANGE,CONTRACT_ACTION,CONTRACT_BYTECODE | The list of sidecar transaction record types to process                                                                                                                                                                                   |
