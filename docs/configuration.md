...
| `hedera.mirror.importer.parser.record.entity.sql.connectionsThreadPoolSize` | 15                      | The number of threads to ingest record items across during batch processing                            |
...
| `hedera.mirror.importer.parser.record.entity.sql.parallelIngestion`         | false                   | Whether to ingest domain objects across a single connection or multiple connections  |
