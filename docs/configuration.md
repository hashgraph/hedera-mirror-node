...
| `hedera.mirror.parser.record.persistNonFeeTransfersAlways` | false                   | Persist non-fee transfers for successful transactions always or only when record's transferlist is not itemized |
