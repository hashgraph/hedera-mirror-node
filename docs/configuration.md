...
| `hedera.mirror.importer.parser.transactionSignatureTypes`                   | SCHEDULECREATE, SCHEDULESIGN | A list of transaction types whose transaction signatures will be stored                   |
