...
| `hedera.mirror.rest.maxTimestampRange         `          | 31536000000             | The maximum number of milliseconds a timestamp range query param can span for some APIs. Default is 1 year.         |
