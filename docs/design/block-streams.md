...
| Database                  | Block Item                                                                              |
| ------------------------- | --------------------------------------------------------------------------------------- |
| ethereum_transaction.hash | transaction_output.ethereum_call.ethereum_hash                                          |
| entity.id                 | transaction_output.ethereum_call.ethereum_call_result/ethereum_create_result.contractId |
...
| Database    | Block Item                                                     |
| ----------- | -------------------------------------------------------------- |
| schedule.id | state_changes[i].state_change.map_update.value.schedule_id_key |
...
| Database  | Block Item                                                       |
| --------- | ---------------------------------------------------------------- |
| entity.id | transaction_output.sign_schedule_output.scheduled_transaction_id |
...
| Database                 | Block Item                                                   |
| ------------------------ | ------------------------------------------------------------ |
| token_account.account_id | transaction_result.automatic_token_associations[i].accountId |
| token_account.token_id   | transaction_result.automatic_token_associations[i].tokenId   |
...
| topic_message.consensus_timestamp  | state_changes.consensus_timestamp                                                   |
| topic_message.running_hash         | state_changes[i].state_change.map_update.value.runningHash                          |
| topic_message.running_hash_version | No longer submitted by the block stream: Fixed value only updated with a HIP change |
| topic_message.sequence_number      | state_changes[i].state_change.map_update.value.sequenceNumber                       |
| topic_message.topic_id             | state_changes[i].state_change.map_update.value.topicId                              |
