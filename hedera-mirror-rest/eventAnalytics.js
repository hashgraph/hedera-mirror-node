...
const getEventAnalytics = function(req, res) {
  ...
  const pgCreatedEventsCountQuery = utils.convertMySqlStyleQueryToPostgres(
  ...
  const pgConsensusEventsCountQuery = utils.convertMySqlStyleQueryToPostgres(
  ...
  const pgSysAppTxsCountInConsensusEventsCountQuery = utils.convertMySqlStyleQueryToPostgres(
