...
| `hedera.mirror.test.acceptance.operatorBalance`                | 30000000000                                  | The amount of tinybars to fund the operator. Applicable only when `createOperatorAccount` is `true`.      |
