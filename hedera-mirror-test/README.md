...
| `hedera.mirror.test.acceptance.operatorKey`                    | Genesis key                                  | Operator private key used to sign transactions in hex encoded DER format.                                 |
| `hedera.mirror.test.acceptance.operatorKeyAlgorithm`           | ED25519                                      | Operator private key signing algorithm: ECDSA or ED25519.                                                 |
