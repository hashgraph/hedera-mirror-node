...
public class EstimatePrecompileFeature extends AbstractEstimateFeature {
    ...
    enum ContractMethods implements ContractMethodInterface {
        ALLOWANCE("allowanceExternal", 27339),
        ALLOWANCE_ERC("allowance", 28119),
        APPROVE("approveExternal", 732042),
        APPROVE_NFT("approveNFTExternal", 731772),
        APPROVE_ERC("approve", 732356),
        ASSOCIATE_TOKEN("associateTokenExternal", 731749),
        ASSOCIATE_TOKENS("associateTokensExternal", 732585),
        BALANCE_OF("balanceOf", 27672),
        BALANCE_OF_NFT("balanceOfIERC721", 27228),
        BURN_TOKEN("burnTokenExternal", 42205),
        CREATE_FUNGIBLE_TOKEN("createFungibleTokenPublic", 207183),
        CREATE_FUNGIBLE_TOKEN_WITH_CUSTOM_FEES("createFungibleTokenWithCustomFeesPublic", 185927),
        CREATE_NFT("createNonFungibleTokenPublic", 207111),
        CREATE_NFT_WITH_CUSTOM_FEES("createNonFungibleTokenWithCustomFeesPublic", 212726),
        CRYPTO_TRANSFER("cryptoTransferExternal", 49824),
        CRYPTO_TRANSFER_HBARS("cryptoTransferExternal", 34135),
        CRYPTO_TRANSFER_NFT("cryptoTransferExternal", 62562),
        DECIMALS("decimals", 27393),
        DELETE_TOKEN("deleteTokenExternal", 40071),
        DISSOCIATE_AND_ASSOCIATE("dissociateAndAssociateTokenExternal", 1437735),
        DISSOCIATE_TOKEN("dissociateTokenExternal", 731551),
        DISSOCIATE_TOKENS("dissociateTokensExternal", 732757),
        EXCHANGE_RATE_TINYCENTS_TO_TINYBARS("tinycentsToTinybars", 25784),
        EXCHANGE_RATE_TINYBARS_TO_TINYCENTS("tinybarsToTinycents", 25894),
        FREEZE_TOKEN("freezeTokenExternal", 41453),
        GET_APPROVED("getApprovedExternal", 27808),
        GET_APPROVED_ERC("getApproved", 27651),
        GET_FUNGIBLE_TOKEN_INFO("getInformationForFungibleToken", 56456),
        GET_NON_FUNGIBLE_TOKEN_INFO("getInformationForNonFungibleToken", 58588),
        GET_TOKEN_DEFAULT_FREEZE_STATUS("getTokenDefaultFreeze", 25375),
        GET_TOKEN_DEFAULT_KYC_STATUS("getTokenDefaultKyc", 25406),
        GET_TOKEN_EXPIRY_INFO("getTokenExpiryInfoExternal", 28671),
        GET_TOKEN_INFO("getInformationForToken", 55815),
        GET_TOKEN_INFO_NFT("getInformationForToken", 55815),
        GET_TOKEN_KEY("getTokenKeyExternal", 30862),
        GET_TOKEN_TYPE("getType", 25386),
        GRANT_KYC("grantTokenKycExternal", 41783),
        IS_APPROVED_FOR_ALL("isApprovedForAllExternal", 27648),
        IS_APPROVED_FOR_ALL_ERC("isApprovedForAll", 28158),
        IS_TOKEN("isTokenExternal", 26840),
        IS_FROZEN("isTokenFrozen", 25970),
        IS_KYC("isKycGranted", 25937),
        MINT_TOKEN("mintTokenExternal", 42621),
        MINT_NFT("mintTokenExternal", 312128),
        NAME("name", 28094),
        NAME_NFT("nameIERC721", 28159),
        ...
        OWNER_OF("getOwnerOf", 27661),
        PSEUDO_RANDOM_SEED("getPseudorandomSeed", 37711),
        PSEUDO_RANDOM_NUMBER("getPseudorandomNumber", 38344),
        REVOKE_KYC("revokeTokenKycExternal", 41189),
        REDIRECT_FOR_TOKEN_ALLOWANCE("allowanceRedirect", 33829),
        REDIRECT_FOR_TOKEN_APPROVE("approveRedirect", 738006),
        REDIRECT_FOR_TOKEN_BALANCE_OF("balanceOfRedirect", 33118),
        REDIRECT_FOR_TOKEN_DECIMALS("decimalsRedirect", 32577),
        REDIRECT_FOR_TOKEN_GET_APPROVED("getApprovedRedirect", 23422),
        REDIRECT_FOR_TOKEN_GET_OWNER_OF("getOwnerOfRedirect", 33076),
        REDIRECT_FOR_TOKEN_IS_APPROVED_FOR_ALL("isApprovedForAllRedirect", 33867),
        REDIRECT_FOR_TOKEN_NAME("nameNFTRedirect", 33781),
        REDIRECT_FOR_TOKEN_SYMBOL("symbolNFTRedirect", 33802),
        REDIRECT_FOR_TOKEN_NAME_NFT("nameRedirect", 23422),
        REDIRECT_FOR_TOKEN_SYMBOL_NFT("symbolRedirect", 23422),
        REDIRECT_FOR_TOKEN_SET_APPROVAL_FOR_ALL("setApprovalForAllRedirect", 738015),
        REDIRECT_FOR_TOKEN_TOTAL_SUPPLY("totalSupplyRedirect", 23422),
        REDIRECT_FOR_TOKEN_TOKEN_URI("tokenURIRedirect", 34280),
        ...
        SET_APPROVAL_FOR_ALL("setApprovalForAllExternal", 732147),
        SYMBOL("symbol", 28137),
        SYMBOL_NFT("symbolIERC721", 28136),
        TOTAL_SUPPLY("totalSupply", 27350),
        TOTAL_SUPPLY_NFT("totalSupplyIERC721", 27328),
        TOKEN_URI("tokenURI", 28318),
        TRANSFER_ERC("transfer", 42138),
        TRANSFER_FROM("transferFromExternal", 44351),
        TRANSFER_FROM_ERC("transferFrom", 42475),
        TRANSFER_FROM_NFT("transferFromNFTExternal", 59184),
        TRANSFER_NFT("transferNFTExternal", 56431),
        TRANSFER_NFTS("transferNFTsExternal", 60385),
        TRANSFER_TOKEN("transferTokenExternal", 39666),
        TRANSFER_TOKENS("transferTokensExternal", 46738),
        UNFREEZE_TOKEN("unfreezeTokenExternal", 41761),
        WIPE_TOKEN_ACCOUNT("wipeTokenAccountExternal", 41488),
        WIPE_NFT_ACCOUNT("wipeTokenAccountNFTExternal", 42589),
        PAUSE_TOKEN("pauseTokenExternal", 40247),
        PAUSE_UNPAUSE_NESTED_TOKEN("nestedPauseUnpauseTokenExternal", 54237),
        UNPAUSE_TOKEN("unpauseTokenExternal", 40137),
        UPDATE_TOKEN_EXPIRY("updateTokenExpiryInfoExternal", 41862),
        UPDATE_TOKEN_INFO("updateTokenInfoExternal", 88807),
        UPDATE_TOKEN_KEYS("updateTokenKeysExternal", 71785),
        MINT_FUNGIBLE_TOKEN_GET_TOTAL_SUPPLY_AND_BALANCE("mintTokenGetTotalSupplyAndBalanceOfTreasury", 69268),
        MINT_NFT_GET_TOTAL_SUPPLY_AND_BALANCE("mintTokenGetTotalSupplyAndBalanceOfTreasury", 336995),
        BURN_FUNGIBLE_TOKEN_GET_TOTAL_SUPPLY_AND_BALANCE("burnTokenGetTotalSupplyAndBalanceOfTreasury", 67321),
        BURN_NFT_GET_TOTAL_SUPPLY_AND_BALANCE("burnTokenGetTotalSupplyAndBalanceOfTreasury", 66886),
        WIPE_FUNGIBLE_TOKEN_GET_TOTAL_SUPPLY_AND_BALANCE("wipeTokenGetTotalSupplyAndBalanceOfAccount", 89391),
        WIPE_NFT_GET_TOTAL_SUPPLY_AND_BALANCE("wipeTokenGetTotalSupplyAndBalanceOfAccount", 90012),
        PAUSE_UNPAUSE_GET_STATUS("pauseTokenGetPauseStatusUnpauseGetPauseStatus", 98714),
        FREEZE_UNFREEZE_GET_STATUS("freezeTokenGetFreezeStatusUnfreezeGetFreezeStatus", 58018),
        APPROVE_FUNGIBLE_GET_ALLOWANCE("approveTokenGetAllowance", 733953),
        APPROVE_NFT_GET_ALLOWANCE("approveTokenGetAllowance", 733990),
        ...
        APPROVE_FUNGIBLE_TOKEN_AND_TRANSFER("approveFungibleTokenTransferFromGetAllowanceGetBalance", 785141),
        APPROVE_NFT_TOKEN_AND_TRANSFER_FROM("approveNftAndTransfer", 797376);
