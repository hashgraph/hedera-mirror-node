...
public class EquivalenceFeature extends AbstractFeature{
    ...
    public void createNewEstimateContract() throws IOException {
        ...
        equivalenceContractSolidityAddress = deployedEquivalenceDestruct.contractId().toSolidityAddress();
    }
    ...
    public void selfDestructAndSetBeneficiary(String beneficiary){
        ...
        var message = executeContractCallTransaction(deployedEquivalenceDestruct.contractId(), "destroyContract", parameters, null);
