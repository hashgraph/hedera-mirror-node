...
public class CallFeature extends AbstractFeature {
    ...
    public void directCallTowardsEthereumPrecompileRIPEMD() {
    ...
    public void directCallTowardsEthereumPrecompileIdentity() {
    ...
    public void directCallTowardsEthereumPrecompileModexp() {
    ...
    public void directCallTowardsEthereumPrecompileEcAdd() {
    ...
    public void directCallTowardsEthereumPrecompileEcMul() {
    ...
    public void directCallTowardsEthereumPrecompileEcPairing() {
    ...
    public void directCallTowardsEthereumPrecompileBlake2f() {
