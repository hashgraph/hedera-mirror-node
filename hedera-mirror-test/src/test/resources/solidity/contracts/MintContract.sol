...
//    function mintAndTransferFungibleToken(uint64 amount, address sender, address receiver) external {
...
//        }
//
//        responseCode = HederaTokenService.transferToken(tokenAddress, sender, receiver, int64(amount));
//        if (responseCode != HederaResponseCodes.SUCCESS) {
//            revert ("Fungible transfer failed!");
//        }
//    }

    function mintAndTransferNonFungibleToken(uint64 amount, address sender, address receiver, bytes[] memory metadata, int64 serialNumber) external {
...
//        responseCode = HederaTokenService.transferNFT(tokenAddress, sender, receiver, serialNumber);
//        if (responseCode != HederaResponseCodes.SUCCESS) {
