...
public class AbstractRecordFileLoggerTest extends IntegrationTest {
    ...
    protected final void assertRecord(TransactionRecord record, Transaction dbTransaction) {
        final com.hedera.mirror.importer.domain.Entities dbPayerEntity = entityRepository.findById(dbTransaction.getPayerAccountId()).get();
    ...
    protected final void assertTransaction(TransactionBody transactionBody,
        ...
        final com.hedera.mirror.importer.domain.Entities dbNodeEntity = entityRepository.findById(dbTransaction.getNodeAccountId()).get();
