...
|                                                 |                    |                            |                                                                                                                                                                                                                                     |
| Configure distribution of transactions          |                    |                            |                                                                                                                                                                                                                                     |
| `faker.transaction.cryptoTransactionsFrequency` | int                | 990                        | Relative frequency of crypto transactions                                                                                                                                                                                           |
| `faker.transaction.fileTransactionsFrequency`   | int                | 10                         | Relative frequency of file transactions                                                                                                                                                                                             |
|                                                 |                    |                            |                                                                                                                                                                                                                                     |
...
| `faker.transaction.crypto.createsFrequency`     | int                | 10                         | Relative frequency of CREATECRYPTOACCOUNT transactions                                                                                                                                                                              |
| `faker.transaction.crypto.transfersFrequency`   | int                | 988                        | Relative frequency of CRYPTOTRANSFER transactions                                                                                                                                                                                   |
| `faker.transaction.crypto.updatesFrequency`     | int                | 1                          | Relative frequency of CRYPTOUPDATEACCOUNT transactions                                                                                                                                                                              |
| `faker.transaction.crypto.deletesFrequency`     | int                | 1                          | Relative frequency of CRYPTODELETE transactions                                                                                                                                                                                     |
|                                                 |                    |                            |                                                                                                                                                                                                                                     |
...
| `faker.transaction.file.createsFrequency`       | int                | 800                        | Relative frequency of FILECREATE transactions                                                                                                                                                                                       |
| `faker.transaction.file.appendsFrequency`       | int                | 100                        | Relative frequency of FILEAPPEND transactions                                                                                                                                                                                       |
| `faker.transaction.file.updatesFrequency`       | int                | 80                         | Relative frequency of FILEUPDATE transactions                                                                                                                                                                                       |
| `faker.transaction.file.deletesFrequency`       | int                | 20                         | Relative frequency of FILEDELETE transactions                                                                                                                                                                                       |
