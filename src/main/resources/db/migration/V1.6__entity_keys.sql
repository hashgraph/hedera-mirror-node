...
create index idx__t_entities__ed25519_public_key_hex
    on t_entities (ed25519_public_key_hex);
...
--
-- Remove admin_key and affected functions.
--
drop function f_entity_create;

alter table t_entities
    drop column admin_key;
