...
public class Utility {
    ...
    public static File getResource(String path) {
        ClassLoader[] classLoaders = {Thread
                .currentThread().getContextClassLoader(), Utility.class.getClassLoader(), ClassLoader.getSystemClassLoader()};
        URL url = null;
    ...
    String protobufKeyToHexIfEd25519OrNull(@Nullable final byte[] protobufKey)
            throws InvalidProtocolBufferException {
