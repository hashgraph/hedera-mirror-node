...
class ClonerTest extends IntegrationTest {
    ...
    void deepClone() {
        ...
        Contract contractClone = cloner.deepClone(contract);
        assertThat(contractClone).isNotSameAs(contract).isEqualTo(contract);
    }
}
