...
import static com.hedera.mirror.importer.converter.RoyaltyFeeConverter.INSTANCE;
    ...
    void testConvert() {
        ...
        pgObject.setValue(
                ...
                [{
                    ...
                    "fallback_fee":{
                        "amount": 16,
                        "denominating_token_id": 1
                    }
                }]
                """);

        var expected = RoyaltyFee.builder()
                ...
                .fallbackFee(FallbackFee.builder()
                        .amount(16L)
                        .denominatingTokenId(EntityId.of(1, EntityType.TOKEN))
                        .build())
                .build();
