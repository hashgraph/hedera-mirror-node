...
class CryptoUpdateTransactionHandlerTest extends AbstractTransactionHandlerTest {
    ...
    protected TransactionHandler getTransactionHandler() {
        return new CryptoUpdateTransactionHandler(entityIdService, new RecordParserProperties());
    }
    ...
    private void assertCryptoUpdate(Optional<Entity> actualEntity, long timestamp, Consumer<Entity> extraAssert) {
    ...
    private void setupForCryptoUpdateTransactionTest(RecordItem recordItem, Consumer<Entity> extraAssertions) {
        ...
        var transaction = domainBuilder.transaction()
                ...
                .get();
        var actualEntity = getTransactionHandler().updateTransaction(transaction, recordItem);
        assertCryptoUpdate(actualEntity, timestamp, extraAssertions);
    }
}
