...
\copy (select * from account_balance_file) to account_balance_file.csv delimiter ',' csv;
...
\copy (select * from token) to token.csv delimiter ',' csv;

\copy (select * from token_account) to token_account.csv delimiter ',' csv;
