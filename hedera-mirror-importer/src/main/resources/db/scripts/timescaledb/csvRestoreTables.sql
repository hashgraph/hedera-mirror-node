...
\copy token_account (account_id, associated, created_timestamp, freeze_status, kyc_status, modified_timestamp, token_id, auto_associated) from token_account.csv csv;
