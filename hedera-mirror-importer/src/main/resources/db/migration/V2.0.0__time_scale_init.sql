...
insert into t_application_status (status_name, status_code) values
    ('Last valid downloaded record file name', 'LAST_VALID_DOWNLOADED_RECORD_FILE'),
 ...
 insert into t_entity_types (id, name) values
    (1, 'account'),
    (2, 'contract'),
    (3, 'file'),
    (4, 'topic'),
 ...
 insert into t_transaction_results (result, proto_id) values
    ('OK', 0),
