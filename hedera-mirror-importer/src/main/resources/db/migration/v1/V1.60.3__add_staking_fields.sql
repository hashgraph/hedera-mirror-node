alter table if exists contract
    ...
    add column if not exists staked_account_id  bigint  null,
    add column if not exists staked_node_id     bigint  null,
    add column if not exists stake_period_start bigint  null;
