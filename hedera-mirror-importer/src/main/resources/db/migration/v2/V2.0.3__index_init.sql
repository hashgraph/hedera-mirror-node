...
alter table if exists contract_log
    add constraint contract_log__pk primary key (consensus_timestamp, index, contract_id, payer_account_id);
...
alter table if exists contract_result
    add constraint contract_result__pk primary key (consensus_timestamp, contract_id, payer_account_id);
