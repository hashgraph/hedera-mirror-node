...
-- token_account
select create_hypertable('token_account', 'id', chunk_time_interval => 10000,
                         if_not_exists => true);

-- token_balance
select create_hypertable('token_balance', 'consensus_timestamp', chunk_time_interval => 604800000000000,
                         if_not_exists => true);

-- token_transfer
select create_hypertable('token_transfer', 'consensus_timestamp', chunk_time_interval => 604800000000000,
                         if_not_exists => true);

-- topic_message
select create_hypertable('topic_message', 'consensus_timestamp', chunk_time_interval => 604800000000000,
                         if_not_exists => true);

-- transaction
select create_hypertable('transaction', 'consensus_ns', chunk_time_interval => 604800000000000,
                         if_not_exists => true);
