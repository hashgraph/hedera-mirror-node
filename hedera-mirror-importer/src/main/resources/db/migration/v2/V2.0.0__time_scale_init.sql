...
-- views for accounts and contracts
...
comment on view account_contract_asc is 'A view for accounts and contracts entities in asc order by id';
...
comment on view account_contract_asc is 'A view for accounts and contracts entities in desc order by id';
