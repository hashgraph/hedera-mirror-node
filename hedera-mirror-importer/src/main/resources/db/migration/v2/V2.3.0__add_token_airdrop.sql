...
select create_distributed_table('token_airdrop', 'token_id', colocate_with => 'entity');
select create_distributed_table('token_airdrop_history', 'token_id', colocate_with => 'token_airdrop');
