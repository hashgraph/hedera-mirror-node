...
select partman.create_parent('public.contract', 'id', 'native', ${partitionIdInterval});
...
select partman.create_parent('public.contract_state', 'contract_id', 'native', ${partitionIdInterval});
select partman.create_parent('public.contract_state_change', 'consensus_timestamp', 'native', ${partitionIdInterval});
select partman.create_parent('public.crypto_allowance', 'owner', 'native', ${partitionIdInterval});
select partman.create_parent('public.crypto_allowance_history', 'owner', 'native', ${partitionIdInterval});
...
select partman.create_parent('public.entity', 'id', 'native', ${partitionIdInterval});
select partman.create_parent('public.entity_history', 'id', 'native', ${partitionIdInterval});
select partman.create_parent('public.entity_stake', 'id', 'native', ${partitionIdInterval});
...
select partman.create_parent('public.nft', 'token_id', 'native', ${partitionIdInterval});
select partman.create_parent('public.nft_allowance', 'owner', 'native', ${partitionIdInterval});
select partman.create_parent('public.nft_allowance_history', 'owner', 'native', ${partitionIdInterval});
...
select partman.create_parent('public.schedule', 'schedule_id', 'native', ${partitionIdInterval});
...
select partman.create_parent('public.token', 'token_id', 'native', ${partitionIdInterval});
select partman.create_parent('public.token_account', 'token_id', 'native', ${partitionIdInterval});
select partman.create_parent('public.token_account_history', 'token_id', 'native', ${partitionIdInterval});
select partman.create_parent('public.token_allowance', 'owner', 'native', ${partitionIdInterval});
select partman.create_parent('public.token_allowance_history', 'owner', 'native', ${partitionIdInterval});
...
select partman.create_parent('public.transaction_signature', 'entity_id', 'native', ${partitionIdInterval});
