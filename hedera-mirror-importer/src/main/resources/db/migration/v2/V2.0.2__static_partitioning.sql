...
select partman.create_parent('public.transaction', 'consensus_timestamp', 'native', 'monthly', p_epoch := 'nanoseconds' , p_premake := 2, p_start_partition := to_char(CURRENT_TIMESTAMP-'3 years'::interval, 'YYYY-MM-DD HH24:MI:SS'));
