...
class SystemDeleteTransactionHandler extends AbstractEntityCrudTransactionHandler {
    ...
    SystemDeleteTransactionHandler(EntityIdService entityIdService, RecordParserProperties recordParserProperties) {
        super(entityIdService, recordParserProperties, TransactionType.SYSTEMDELETE);
    }
