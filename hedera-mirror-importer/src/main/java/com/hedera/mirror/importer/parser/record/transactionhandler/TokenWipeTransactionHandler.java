...
@Named
class TokenWipeTransactionHandler extends AbstractContractCallTransactionHandler {

    TokenWipeTransactionHandler(EntityIdService entityIdService, EntityListener entityListener,
