...
@Named
class TokenAssociateTransactionHandler extends AbstractContractCallTransactionHandler {

    TokenAssociateTransactionHandler(EntityIdService entityIdService, EntityListener entityListener,
