...
public class FixedFeeConverter extends AbstractFeeConverter implements Converter<PGobject, List<FixedFee>> {

    public static final FixedFeeConverter INSTANCE = new FixedFeeConverter();

    @SneakyThrows
    @Override
    public List<FixedFee> convert(PGobject source) {
