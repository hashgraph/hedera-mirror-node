...
@Named
class CryptoTransferTransactionHandler extends AbstractContractCallTransactionHandler {

    CryptoTransferTransactionHandler(EntityIdService entityIdService, EntityListener entityListener,
