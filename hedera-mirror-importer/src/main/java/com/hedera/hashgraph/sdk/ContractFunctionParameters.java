...
public final class ContractFunctionParameters {
     ...
     * @return {@code this}
     * @throws IllegalArgumentException if {@code bigInt.bitLength() > 255} (max range including the sign bit).
     */
     ...
     * @param intArray The array of integers to be added
     * @return {@code this}
     * @throws IllegalArgumentException if any value's {@code .bitLength() > 255} (max range including the sign bit).
     */
     ...
     * @return {@code this}
     * @throws IllegalArgumentException if {@code bigUint.bitLength() > 256} (max range including the sign bit) or
     ...
     * <p>
     * Each value will be treated as unsigned during encoding (it will be zero-padded instead of sign-extended to 32
     * bytes).
     *
     * @param intArray The array of integers to be added
     * @return {@code this}
     ...
     * @param intArray The array of integers to be added
     * @return {@code this}
     * @throws IllegalArgumentException if any value has a {@code .bitLength() > 256} (max range including the sign bit)
     *                                  or is negative.
     */
    ...
    /**
     * Add a Solidity function reference as a {@value ADDRESS_LEN}-byte contract address and a {@value
     * SELECTOR_LEN}-byte function selector.
     *
     * @param address  a hex-encoded {@value ADDRESS_LEN_HEX}-character Solidity address.
     * @param selector a
     * @return {@code this}
     * @throws IllegalArgumentException if {@code address} is not {@value ADDRESS_LEN_HEX} characters or {@code
     *                                  selector} is not {@value SELECTOR_LEN} bytes.
     */
    ...
    /**
     * Add a Solidity function reference as a {@value ADDRESS_LEN}-byte contract address and a constructed {@link
     * ContractFunctionSelector}. The {@link ContractFunctionSelector} may not be modified after this call.
     *
