...
dependencies {
    constraints {
        ...
        api("com.google.cloud:spring-cloud-gcp-dependencies:5.0.1")
        ...
        api("io.hypersistence:hypersistence-utils-hibernate-63:3.7.2")
        ...
        api("software.amazon.awssdk:bom:2.23.17")
