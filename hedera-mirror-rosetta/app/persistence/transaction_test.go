...
func (suite *transactionRepositorySuite) setupDb(createTokenEntity bool) []*types.Transaction {
	...
	expectedTransaction1 := &types.Transaction{Hash: "0x010203", Memo: []byte("simple transfer"), Operations: operations1}
	...
	addTransaction(dbClient, consensusTimestamp, &tokenId3, &nodeEntityId, firstEntityId, 22,
		[]byte{0xaa, 0x11, 0x22}, domain.TransactionTypeTokenCreation, validStartNs, cryptoTransfers, nil, nil, nil, nil)
	metadata = map[string]interface{}{
		"currency": &rTypes.Currency{
