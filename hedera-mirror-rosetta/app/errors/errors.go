...
const (
	...
	EndpointNotSupportedInOfflineMode string = "Endpoint not supported in offline mode"
...
func AddErrorDetails(err *types.Error, details map[string]interface{}) *types.Error {
	clone := *err
