...
[![CircleCI](https://circleci.com/gh/hashgraph/hedera-mirror-node/tree/master.svg?style=shield)](https://circleci.com/gh/hashgraph/hedera-mirror-node/tree/master) [![codecov](https://img.shields.io/codecov/c/github/hashgraph/hedera-mirror-node/master)](https://codecov.io/gh/hashgraph/hedera-mirror-node) [![GitHub](https://img.shields.io/github/license/hashgraph/hedera-mirror-node)](https://github.com/steven-sheehy/hedera-mirror-node/tree/65a5bf2feb6610c31745c797582209bc03129d1e/LICENSE/README.md)
...
| :--- | :--- |
| accessKey | HEDERA\_S3\_ACCESS\_KEY |
| secretKey | HEDERA\_S3\_SECRET\_KEY |
...
Flyway \([https://flywaydb.org/getstarted/](https://flywaydb.org/getstarted/)\) is used to manage the database schema.
...
Unit tests: You can also unittest using jest by using `npm test`. Acceptance tests: To test against a live instance, you can use `npm run acceptancetest`. You need to specify the instance ip:port as `TARGET` environment variable for this.
...
Apache License 2.0, see [LICENSE](https://github.com/steven-sheehy/hedera-mirror-node/tree/65a5bf2feb6610c31745c797582209bc03129d1e/LICENSE/README.md).
