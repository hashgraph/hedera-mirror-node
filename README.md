...
- Beta mirror node software receives these files, validates them (ensure authenticity by verifying signatures of a supermajority of mainnet nodes, verifying chain of hashes on files), parses the information in these files, puts data in a database, and offers a REST API to query the information
